<template>
  <div class="settings">
    <div class="container">
      <div class="user" v-if="settings.user.nickname !== undefined">
        <div class="left">
          <img class="avatar" :src="settings.user.avatarUrl" />
          <div class="info">
            <div class="nickname">{{ settings.user.nickname }}</div>
            <div class="extra-info">
              <span v-if="settings.user.vipType !== 0" class="vip"
                ><img
                  class="cvip"
